...
| 플랫폼 | 파일 | 크기 |
|---|---|---|
| **macOS** 26 이상 | [MeetingScribe-0.1.2.dmg](https://github.com/soulairise/meeting-scribe/releases/download/v0.1.2/MeetingScribe-0.1.2.dmg) | 492KB |
| **Windows** 10 20H1 이상 (x64) | [MeetingScribe-0.1.2-win-x64.zip](https://github.com/soulairise/meeting-scribe/releases/download/v0.1.2/MeetingScribe-0.1.2-win-x64.zip) | 64MB |
...
`build/MeetingScribe-0.1.2.dmg` — 드래그해서 응용 프로그램에 넣는다.
